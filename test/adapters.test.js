...
test("official OAuth adapters are gated until user controls and import workers exist", () => {
  ...
  assert.throws(() => adapter.importActivities(), /disconnect\/delete\/export controls/u);
});
